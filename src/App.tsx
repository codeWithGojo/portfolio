...
const projects = [
  ...
  },
  {
    ...
    tags: ["Frontend", "Sports Analytics"],
    status: "Live",
    why: "I follow football, basketball, and African competitive CODM. I wanted one place that could cover all three and show the reasoning behind a prediction, not just throw out a score.",
    built: "A dark-blue browser-based platform covering Europe’s top five football leagues, NBA games, and curated African CODM teams. It calculates win, draw, loss, Over/Under, likely scores, and confidence with a Poisson model.",
    learned: "A probability needs context. Showing the model, confidence, and different outcome types makes the result easier to question instead of asking people to trust one number.",
    challenge: "Working client-side while handling inconsistent sports data and presenting uncertainty clearly. The current SportScore API setup is a foundation for stronger data sources later.",
    outcome: "A working multi-sport analysis tool that runs entirely in the browser.",
    tech: ["HTML", "Tailwind CSS", "Vanilla JS", "SportScore API", "Poisson model"],
    links: [
      { label: "GitHub", href: "https://github.com/codeWithGojo/PredictArena" },
      { label: "Live demo", href: "https://codewithgojo.github.io/PredictArena/" },
    ],
  },
  {
    number: "05",
